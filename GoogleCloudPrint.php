...
class GoogleCloudPrint {
	...
	const JOB_URL			  = "https://www.google.com/cloudprint/interface/jobs";
	...
	public function getJobs($printerid){
		// Prepare authorization headers
		$authheaders = array(
			"Authorization: GoogleLogin auth=" . $this->authtoken
		);
		$responsedata = $this->makeHttpCall(self::JOB_URL,array(),$authheaders);
		return $responsedata;
		//echo $responsedata;
	}
